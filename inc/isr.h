...
//ADC DMA:
#define ISR_DMA2_STREAM0		0	//ADC1	//ToDo: too agressive! Test & change.
#define ISR_SUB_DMA2_STREAM0	0

//UART - RS-485:
#define ISR_UART1				6	//RS-485 #1
#define ISR_SUB_UART1			0
#define ISR_UART6				6	//RS-485 #2
#define ISR_SUB_UART6			1
//(we use DMA, this shouldn't matter)
...
#define ISR_DMA2_STREAM7		3	//USART1 TX
#define ISR_SUB_DMA2_STREAM7	0
#define ISR_DMA2_STREAM6		3	//USART6 TX
#define ISR_SUB_DMA2_STREAM6	1

//UART DMA - Expansion:
#define ISR_DMA1_STREAM1		0	//USART3 RX //ToDo: agressive! Test & change.
#define ISR_SUB_DMA1_STREAM1	0
#define ISR_DMA1_STREAM3		3	//USART3 TX		//ToDo consider lowering
#define ISR_SUB_DMA1_STREAM3	0

//I2C1 DMA:
#define ISR_DMA1_STREAM0		0	//I2C1 RX
#define ISR_SUB_DMA1_STREAM0	0
#define ISR_DMA1_STREAM6		0	//I2C1 TX
#define ISR_SUB_DMA1_STREAM6	0

//I2C21 DMA:
#define ISR_DMA1_STREAM2		0	//I2C2 RX
#define ISR_SUB_DMA1_STREAM2	0
#define ISR_DMA1_STREAM7		0	//I2C2 TX
#define ISR_SUB_DMA1_STREAM7	0
...
//SPI5 - FLASH:
#define ISR_SPI5				7
#define ISR_SUB_SPI5			7

//SPI6 - Expansion:
#define ISR_SPI6				4
#define ISR_SUB_SPI6			7

//Timers:
#define ISR_SYSTICK				0
#define ISR_SUB_SYSTICK			0
#define ISR_TIMER7				2	//10kHz Timebase
#define ISR_SUB_TIMER7			2
